...
(function () {
	...
	var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
		...
		function _onMakeImage() {
			...
			this._elA.download = "QRCode";
			this._elA.style.display = "inline-block";
			// this._elSmall.innerHTML = "点击图片下载";
		}
		...
		var Drawing = function (el, htOption) {
			...
			this._el = el;
			this._elA = document.createElement("a");
			this._el.appendChild(this._elA);
			this._el = this._elA;
			...
			// this._elSmall = this._elA;
			// this._elSmall = document.createElement("small");
			// this._el.appendChild(this._elSmall);
		};
